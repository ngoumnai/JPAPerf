...
public class PopulateDataBaseResource {
    ...
    @POST
    @Path("courseToProfessor")
    @Consumes({"application/xml", "application/json"})
    public void assignCourseToProfessor (TestDataDTO testDataDTO) {
        testDataManager.assignCourseToProfessor(testDataDTO.getNbrMaxCoursPerProfessor());
    }
